...
const Navbar = () => {
  ...
  return (
    <nav 
      ...
      items-center py-8 fiexd top-0 z-20 `}
    >
      ...
      items-center max-w-7xl mx-auto">
        <Link to="/" className="flex items-center gap-3" onClick={() =>{
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer">Matheus <span className="
          sm:block">| Estudante de Programação </span></p>
        </Link>
